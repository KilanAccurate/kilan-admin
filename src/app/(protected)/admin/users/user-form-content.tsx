...
import { formSchema, UserFormProps, UserFormValues } from "./user-form"
...
export function UserFormContent({
    ...
    useEffect(() => {
        ...
        getSiteLocations()
        // const matchedSite = sites.find(site => site._id === userToEdit?.site);
        // if (userToEdit != null) {
        //     form.setValue("site", matchedSite?.siteName ?? '', {
        //         shouldDirty: true,
        //         shouldTouch: true,
        //         shouldValidate: true,
        //     });
